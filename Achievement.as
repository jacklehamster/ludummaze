package  {
	...
	public class Achievement {
		...
		static public const TEN:Object = { name:"Visited 10 games", id:"7930" };
		static public const THIRD:Object = { name:"Visited one third of all games", id:"7931" };
		static public const HALF:Object = { name:"You have played one half of all games!", id:"7932" };
		static public const VIDEO:Object = { name:"Checked out a video", id:"7937" };
		static public const ALL:Object = { name:"You have tried all Ludum Dare 29 games!", id:"7933" };		
		static public const JACK:Object = { name:"Find me", id:"7934" };
		
		static private const GAMEJOLT_ID:String = "25987";
		static private const GAMEJOLT_KEY:String = "a4d938f075f3076e1b5c701323a918c3";
		...
		static public function init(mc:MovieClip):void {
			root = mc;
			if(isNewgrounds()) {
				API.connect(root, "36895:8BMF76w4", "LeCLmlsqSmVwVnZGYFIFQYHOEHcOCUDF");
			}
			if(isKongregate()) {
